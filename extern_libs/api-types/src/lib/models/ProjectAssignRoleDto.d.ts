 ...
 */
export declare class ProjectAssignRoleDto {
    /**
    ...
    'account_id': string;
    /**
     * list of roles that should be assigned to the selected account. Strings must match role labels.
     */
    'roles'?: Array<string>;
    /**
     * defines the attributes that are used for overwrite
     */
