 ...
 */
export declare class AccountChangeDto {
    /**
     * yyyy-MM-DD
     */
    'birthday'?: string;
     ...
     */
    'email': string;
    'gender'?: AccountChangeDtoGenderEnum;
    'first_name'?: string;
    'last_name'?: string;
    'organization'?: string;
    'state'?: string;
...
export type AccountChangeDtoGenderEnum = 'male' | 'female' | 'divers';
export type AccountChangeDtoRoleEnum = 'administrator' | 'user' | 'app';
