...
export class SettingsService {
  ...
  public loadApplicationSettings(queryParams: any): Promise<void> {
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      afterDefined(this.store.select(fromApplication.selectApplication))
        .then(() => {
          ...
          this.loadDB(queryParams)
            .then(() => {
              ...
              if (
                ...
                if (
                  this.appSettings.octra.languages.find((value) => {
              ...
              if (this.appSettings === undefined) {
                ...
                this.api.webToken =
                  this.appStorage?.onlineSession?.loginData?.webToken;
              }
