 ...
 */
import { ToolConfigurationAssetChangeDto } from '../models/ToolConfigurationAssetChangeDto';

export declare class ToolConfigurationChangeDto {
  'name': string;
  'assets'?: Array<ToolConfigurationAssetChangeDto>;
  'standard'?: boolean;
  'value'?: any;
