 ...
 */
import { SupportedTaskTypesConstraints } from '../models/SupportedTaskTypesConstraints';

export declare class SupportedTaskTypeStatement {
  'name': string;
  'combination': string;
  'description'?: string;
  'optional'?: boolean;
  ...
  'take'?: number;
  'takeMax'?: number;
  'constraints': Array<SupportedTaskTypesConstraints>;
