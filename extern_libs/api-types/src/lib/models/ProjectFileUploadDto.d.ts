 ...
 */
export declare class ProjectFileUploadDto {
    /**
     * files to upload.
     */
    'files': Array<any>;
    /**
     * target path (relative to the project folder).
     */
    'target_path'?: string;
    /**
     * defines if old files in the same target folder should be overwritten.
     */
