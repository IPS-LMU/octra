 ...
 */
import { SupportedTaskDto } from '../models/SupportedTaskDto';
import { ToolConfigurationAssetDto } from '../models/ToolConfigurationAssetDto';
import { ToolMinimalDto } from '../models/ToolMinimalDto';

export declare class ToolConfigurationMinimalDto {
  'name': string;
  'id': string;
  'tool'?: ToolMinimalDto;
  'task_type': SupportedTaskDto;
  'assets'?: Array<ToolConfigurationAssetDto>;
