 ...
 */
import { AuthDtoMe } from '../models/AuthDtoMe';

export declare class AuthDto {
  /**
   * if the authentication method is shibboleth, this URL directs to the confirmShibboleth page. If there are pending agreements, this URL directs to the agreement page. Undefined otherwise.
   */
  'openURL'?: string;
  /**
   * this token exists if the authentication was successful (correct credentials & no pending agreements).
   */
  'accessToken'?: string;
  /**
   * this token exists if there are any policies the user has to agree with. `openURL` will direct to an agreement page. The duration of this token is set to 1 hour. This token can only be used on the agreement page.
   */
