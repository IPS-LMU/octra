 ...
 */
import { ProjectDtoStatusStatistics } from '../models/ProjectDtoStatusStatistics';
import { ProjectDtoTasksStatistics } from '../models/ProjectDtoTasksStatistics';

export declare class ProjectDtoStatistics {
  'status': ProjectDtoStatusStatistics;
  'tasks': Array<ProjectDtoTasksStatistics>;
