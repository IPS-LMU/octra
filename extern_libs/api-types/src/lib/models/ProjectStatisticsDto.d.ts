 ...
 */
import { AccountStatisticItemDto } from '../models/AccountStatisticItemDto';
import { ProjectStatisticsDtoTasks } from '../models/ProjectStatisticsDtoTasks';

export declare class ProjectStatisticsDto {
  'tasks': ProjectStatisticsDtoTasks;
  'accounts': Array<AccountStatisticItemDto>;
