 ...
 */
import { SupportedTaskTypeStatement } from '../models/SupportedTaskTypeStatement';

export declare class SupportedTaskTypeSetDefinition {
  'name'?: string;
  'statements': Array<SupportedTaskTypeStatement>;
