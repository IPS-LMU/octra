...
export const authenticationReducer = createReducer(
  initialState,
  on(AuthenticationActions.login.success, AuthenticationActions.reauthenticate.success, (state: AuthenticationState, me) => {
    return {
      ...state,
  ...
  on(AuthenticationActions.logout.success, (state: AuthenticationState, dto) => {
    return {
      ...state,
      authenticated: false,
      type: undefined,
  ...
  on(AuthenticationActions.continueSessionAfterAgreement.success, (state: AuthenticationState, data) => {
    return {
      ...state,
