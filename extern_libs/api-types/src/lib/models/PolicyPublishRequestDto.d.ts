 ...
 */
import { PolicyPublishRequestItemDto } from '../models/PolicyPublishRequestItemDto';

export declare class PolicyPublishRequestDto {
  'items': Array<PolicyPublishRequestItemDto>;
