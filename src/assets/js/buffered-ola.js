...
function BufferedOLA(frameSize) {
    ...
    this.process = function (inputBuffer, outputAudioBuffer) {
    ...
    this.set_window_type = function (windowType) {
        _olaL.set_window_type(windowType);
        _olaR.set_window_type(windowType);
    }
