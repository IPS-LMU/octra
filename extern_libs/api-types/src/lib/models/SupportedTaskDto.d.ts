 ...
 */
import { SupportedTaskDtoStyle } from '../models/SupportedTaskDtoStyle';
import { SupportedTaskTypeSetDefinition } from '../models/SupportedTaskTypeSetDefinition';

export declare class SupportedTaskDto {
  'name': string;
  'neededAssets'?: SupportedTaskTypeSetDefinition;
  'style': SupportedTaskDtoStyle;
