...
export class IDBEffects {
    ...
    this.actions$.pipe(
      ...
      exhaustMap((action) => {
        ...
        Promise.all([
          ...
          .catch((error) => {
            subject.next(
              IDBActions.loadAnnotationFailed({
                error,
              })
            );
            subject.complete();
  ...
  clearAllOptions$ = createEffect(() =>
    this.actions$.pipe(
      filter(
        (a) =>
          a.type === IDBActions.clearAllOptions.type ||
      ...
      exhaustMap((action) => {
        ...
        if (action.saveToDB) {
          this.idbService
            ...
            .catch((error) => {
              subject.next(
                IDBActions.overwriteTranscriptFailed({
                  error,
                })
              );
              subject.complete();
      ...
      mergeMap(([action, appState]: [Action, RootState]) => {
        ...
        if (modeState) {
          ...
          this.idbService
            ...
            .then(() => {
              subject.next(
                IDBActions.saveModeOptionsSuccess({
            ...
            .catch((error) => {
              subject.next(
                IDBActions.saveModeOptionsFailed({
                  error,
                })
              );
              subject.complete();
    ...
    this.actions$.pipe(
      ...
      exhaustMap((action) => {
        ...
        this.idbService
          ...
          .catch((error) => {
            subject.next(
              IDBActions.saveUserProfileFailed({
                error,
              })
            );
            subject.complete();
    ...
    this.actions$.pipe(
      ...
      exhaustMap((action) => {
        ...
        this.idbService
          ...
          .catch((error) => {
            subject.next(
              IDBActions.saveAppLanguageFailed({
                error,
              })
            );
            subject.complete();
    ...
    this.actions$.pipe(
      ...
      exhaustMap((action) => {
        ...
        this.idbService
          ...
          .catch((error) => {
            subject.next(
              IDBActions.saveIDBVersionFailed({
                error,
              })
            );
            subject.complete();
    ...
    this.actions$.pipe(
      ...
      exhaustMap((action) => {
        ...
        this.idbService
          ...
          .catch((error) => {
            subject.next(
              IDBActions.saveShowLoupeFailed({
                error,
              })
            );
            subject.complete();
      ...
      exhaustMap((action) => {
        ...
        if (this.idbService.isReady) {
          this.idbService
            ...
            .catch((error) => {
              subject.next(
                IDBActions.saveSecondsPerLineFailed({
                  error,
                })
              );
              subject.complete();
    ...
    this.actions$.pipe(
      ...
      exhaustMap((action) => {
        ...
        this.idbService
          ...
          .catch((error) => {
            subject.next(
              IDBActions.saveHighlightingEnabledFailed({
                error,
              })
            );
            subject.complete();
    ...
    this.actions$.pipe(
      ...
      mergeMap((action) => {
        ...
        this.idbService
          ...
          .catch((error) => {
            subject.next(
              IDBActions.saveASRSettingsFailed({
                error,
              })
            );
            subject.complete();
    ...
    this.actions$.pipe(
      ...
      exhaustMap((action) => {
        ...
        this.idbService
          ...
          .catch((error) => {
            subject.next(
              IDBActions.saveAudioSettingsFailed({
                error,
              })
            );
            subject.complete();
    ...
    this.actions$.pipe(
      ...
      exhaustMap((action) => {
        ...
        this.idbService
          ...
          .catch((error) => {
            subject.next(
              IDBActions.saveCurrentEditorFailed({
                error,
              })
            );
            subject.complete();
        ...
        this.idbService
          ...
          .then((dbEntries: ConsoleEntry[]) => {
            if (dbEntries !== undefined) {
              subject.next(
                IDBActions.loadConsoleEntriesSuccess({
