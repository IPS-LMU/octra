...
export const selectJobsLeft = pipe(selectOnlineSession, (state) => state.sessionData?.jobsLeft);
...
export const selectServerDataEntry = pipe(selectOnlineSession, state => state.sessionData.serverDataEntry);
