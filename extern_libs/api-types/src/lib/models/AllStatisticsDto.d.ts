 ...
 */
import { AllAccountStatistics } from '../models/AllAccountStatistics';
import { AllProjectsStatistics } from '../models/AllProjectsStatistics';
import { AllStatisticsTasksDto } from '../models/AllStatisticsTasksDto';

export declare class AllStatisticsDto {
  /**
   * date string (Zulu, ISO 8601)
   */
  'last_updated': string;
  'accounts': AllAccountStatistics;
  'projects': AllProjectsStatistics;
  'tasks': AllStatisticsTasksDto;
