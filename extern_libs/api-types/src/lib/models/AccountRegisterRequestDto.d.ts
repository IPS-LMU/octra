 ...
 */
export declare class AccountRegisterRequestDto {
    /**
     * yyyy-MM-DD
     */
    'birthday'?: string;
     ...
     */
    'email': string;
    'gender': AccountRegisterRequestDtoGenderEnum;
    'first_name': string;
    'last_name': string;
    'organization'?: string;
    'state': string;
...
export type AccountRegisterRequestDtoGenderEnum = 'male' | 'female' | 'divers';
