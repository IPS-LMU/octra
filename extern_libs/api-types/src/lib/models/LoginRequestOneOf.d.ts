 ...
 */
export declare class LoginRequestOneOf {
    'type': LoginRequestOneOfTypeEnum;
    /**
     * You can set this value with either a username or an email address.
     */
    'usernameOrEmail': string;
    'password': string;
    /**
     * Defines if app token and session token should be saved as cookies.
     */
    'useCookies'?: boolean;
...
export type LoginRequestOneOfTypeEnum = 'local';
