 ...
 */
import { AllAccountsGenderStatistics } from '../models/AllAccountsGenderStatistics';
import { AllAccountStatisticsRoles } from '../models/AllAccountStatisticsRoles';

export declare class AllAccountStatistics {
  'total': number;
  'activeLast30Days': number;
  'registrationsLast30Days': number;
  'activated': number;
  'deleted': number;
  'gender': AllAccountsGenderStatistics;
  'roles': AllAccountStatisticsRoles;
