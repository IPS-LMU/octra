 ...
 */
import { AccountProjectRoleDto } from '../models/AccountProjectRoleDto';
import { CurrentAccountDtoSystemRole } from '../models/CurrentAccountDtoSystemRole';

export declare class AccountMinimalDto {
  /**
   ...
   * login method
   */
  'loginmethod': AccountMinimalDtoLoginmethodEnum;
  'gender': AccountMinimalDtoGenderEnum;
  'first_name': string;
  'last_name': string;
  'phone': string;
  'timezone': string;
  ...
  'comment'?: string;
  'organization'?: string;
  'systemRole': CurrentAccountDtoSystemRole;
  /**
   * user roles of this account associated to specific projects.
   */
  'projectRoles': Array<AccountProjectRoleDto>;
  /**
...
export type AccountMinimalDtoLoginmethodEnum = 'local' | 'shibboleth';
export type AccountMinimalDtoGenderEnum = 'male' | 'female' | 'divers';
