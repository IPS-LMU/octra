 ...
 */
export declare class ChangeAccountInformationDto {
    /**
     * yyyy-MM-DD
     */
    'birthday'?: string;
    'first_name': string;
    'last_name': string;
    'gender': ChangeAccountInformationDtoGenderEnum;
    'state': string;
    'country': string;
    'organization'?: string;
    'address'?: string;
...
export type ChangeAccountInformationDtoGenderEnum = 'male' | 'female' | 'divers';
