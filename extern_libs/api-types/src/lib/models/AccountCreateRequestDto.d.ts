 ...
 */
export declare class AccountCreateRequestDto {
    /**
     * yyyy-MM-DD
     */
    'birthday'?: string;
     ...
     */
    'role': AccountCreateRequestDtoRoleEnum;
    'organization'?: string;
    'state'?: string;
    'country'?: string;
    'locale'?: string;
    ...
    'comment'?: string;
    'active'?: boolean;
    'gender'?: AccountCreateRequestDtoGenderEnum;
    'first_name'?: string;
    'last_name'?: string;
    'address'?: string;
...
export type AccountCreateRequestDtoRoleEnum = 'administrator' | 'user' | 'app';
export type AccountCreateRequestDtoGenderEnum = 'male' | 'female' | 'divers';
