 ...
 */
import { PolicyTranslationDto } from '../models/PolicyTranslationDto';
...
export declare class PolicyDto {
  ...
  'version': number;
  'translations': Array<PolicyTranslationDto>;
...
export type PolicyDtoTypeEnum = 'privacy' | 'terms_and_conditions';
