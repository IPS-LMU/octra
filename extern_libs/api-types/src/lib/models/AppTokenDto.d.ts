 ...
 */
export declare class AppTokenDto {
    /**
    ...
    'description'?: string;
    /**
     * boolean that describes if registrations may be done from an app that uses this app token.
     */
    'registrations'?: boolean;
    /**
     * boolean that describes if apptoken may be changed
     */
    'readonly'?: boolean;
    /**
