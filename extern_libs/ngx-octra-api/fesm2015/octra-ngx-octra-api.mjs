...
class OctraAPIService {
    ...
    createLocalAccount(dto) {
        return this.post('/accounts', Object.assign({}, dto), true);
    }
    ...
    post(partURL, data, needsJWT, options) {
        const headers = this.getHeaders(needsJWT);
        partURL = partURL.indexOf('/') === 0 ? partURL.substring(1) : partURL;
        return this.http.post(`${this._apiURL}/${partURL}`, data, Object.assign(Object.assign({}, options), { responseType: 'json', headers }));
    }
    ...
    getHeaders(needsJWT) {
        ...
        if (needsJWT && !this.useCookieStrategy) {
            headers = Object.assign(Object.assign({}, headers), { Authorization: `Bearer ${this._webToken}` });
        }
        return headers;
    }
    getCookie(cname) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(OctraAPIService, [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(NgxOctraApiModule, [{
            type: NgModule,
            args: [{
