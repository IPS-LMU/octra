 ...
 */
import { TaskInputOutputDto } from '../models/TaskInputOutputDto';
import { TaskListInputOutputDto } from '../models/TaskListInputOutputDto';
import { ToolConfigurationMinimalDto } from '../models/ToolConfigurationMinimalDto';

export declare class TaskListItemDto {
  /**
   * date string (Zulu, ISO 8601)
   */
  'creationdate'?: string;
  /**
   * date string (Zulu, ISO 8601)
   ...
   */
  'enddate'?: string;
  'inputs': Array<TaskListInputOutputDto>;
  'outputs'?: Array<TaskListInputOutputDto>;
  'tool_configuration'?: ToolConfigurationMinimalDto;
  'nexttask'?: TaskListItemDto;
  /**
  ...
  'assessment'?: string;
  'priority'?: number;
  'status'?: TaskListItemDtoStatusEnum;
  'code'?: string;
  'log'?: any;
  'comment'?: string;
  ...
  'use_outputs_from_task_id'?: string;
  'use_outputs_from_task'?: Array<TaskInputOutputDto>;
...
export type TaskListItemDtoStatusEnum = 'DRAFT' | 'FREE' | 'PAUSED' | 'BUSY' | 'FINISHED' | 'FAILED' | 'POSTPONED';
