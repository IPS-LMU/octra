 ...
 */
export declare class AccountBatchActionDto {
    'action': AccountBatchActionDtoActionEnum;
...
export type AccountBatchActionDtoActionEnum = 'set_active' | 'set_inactive' | 'send_email_verification' | 'send_password_reset';
