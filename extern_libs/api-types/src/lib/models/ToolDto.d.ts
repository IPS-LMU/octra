...
export declare class ToolDto {
    ...
    'processingType'?: ToolDtoProcessingTypeEnum;
    'supportedTaskTypes': Array<string>;
    'url'?: string;
    'pid'?: string;
...
export type ToolDtoTypeEnum = 'web-application' | 'console-application' | 'desktop-application';
export type ToolDtoProcessingTypeEnum = 'manual' | 'automatic';
