 ...
 */
export declare class TaskListInputOutputDto {
    'creator_type'?: TaskListInputOutputDtoCreatorTypeEnum;
    'label'?: string;
    'description'?: string;
    'filename'?: string;
    /**
     * URL is set if the files content is not retrieved from database.
     */
    'url'?: string;
    'fileType'?: string;
...
export type TaskListInputOutputDtoCreatorTypeEnum = 'user' | 'app';
