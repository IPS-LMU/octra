...
export declare class AccountFieldDefinitionCreateDto {
  /**
   * Context where this field is going to be visible
   */
  'context': AccountFieldDefinitionCreateDtoContextEnum;
  /**
...
export type AccountFieldDefinitionCreateDtoContextEnum = 'project' | 'account';
