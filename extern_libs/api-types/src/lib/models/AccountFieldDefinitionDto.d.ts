...
export declare class AccountFieldDefinitionDto {
  /**
   * Context where this field is going to be visible
   */
  'context': AccountFieldDefinitionDtoContextEnum;
  /**
...
export type AccountFieldDefinitionDtoContextEnum = 'project' | 'account';
