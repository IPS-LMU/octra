 ...
 */
export declare class TaskProperties {
    /**
    ...
    'comment'?: string;
    /**
     * id of the tool configuration ion that should be used for this task
     */
    ...
    'nexttask_id'?: string;
    /**
     * id of the task whose outputs should be used as inputs for this task.
     */
    'use_outputs_from_task_id'?: string;
    /**
     * id of the previous task. The task must already exist.
     */
    'previoustask_id'?: string;
    /**
     * directory where the files need to be uploaded to (relative to project path)
     */
     ...
     */
    'log'?: Array<any>;
    'status'?: TaskPropertiesStatusEnum;
...
export type TaskPropertiesStatusEnum = 'DRAFT' | 'FREE' | 'PAUSED' | 'BUSY' | 'FINISHED' | 'FAILED' | 'POSTPONED';
