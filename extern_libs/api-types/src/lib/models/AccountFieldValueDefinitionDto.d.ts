 ...
 */
import { AccountFieldDefinitionCreateDtoDefinition } from '../models/AccountFieldDefinitionCreateDtoDefinition';

export declare class AccountFieldValueDefinitionDto {
  /**
   * Context where this field is going to be visible
   */
  'context': AccountFieldValueDefinitionDtoContextEnum;
  /**
   * Unique name of the definition
   */
  'name': string;
  'type': any;
  'definition': AccountFieldDefinitionCreateDtoDefinition;
  /**
   * Describes if administrators or project administrators may delete this definition
   */
  'removable': boolean;
  /**
...
export type AccountFieldValueDefinitionDtoContextEnum = 'project' | 'account';
